...
public class Controller {
    private FileDataPersistence studentPersistence;
    ...
    public boolean findOne(List<Student> students, String regNumber){
        ...
        for (Student s: students) {
            if(s.getRegNumber().equals(regNumber))
                found=true;
        }
        return found;
    }
    ...
    public boolean saveStudent(Student student) throws IOException {
        ...
        if(!findOne(students, student.getRegNumber())) {
            ...
            System.out.println("Registration number should be unique");
            return false;
        }
    }
